    ...
    <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 text-white p-4 sm:p-8 rounded-2xl border-4 border-orange-500 shadow-2xl max-w-4xl w-full flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
        <div className="flex-shrink-0 w-full sm:w-auto">
          <video autoPlay muted loop className="w-full sm:w-64 h-48 object-cover rounded-lg border-2 border-orange-500">
        ...
        <div className="text-center flex-1">
          <h2 className="text-orange-500 text-xl sm:text-2xl font-bold mb-4">WARNING: This site is for adults only!</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              onClick={() => {
                window.location.href = "https://dimesonly.world/login";
              }}
              type="button"
              className="bg-pink-600 hover:bg-pink-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold transition-colors text-sm sm:text-base cursor-pointer"
            >
              MEMBERS LOGIN
            </button>
          </div>
