...
import { Camera, Gift, Star, Calendar, Car, Shirt, Heart, Flame } from "lucide-react";
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-3 md:gap-4">
        ...
        <div className="col-span-2 md:col-span-6 flex justify-center">
          <Button
            ...
            className="relative min-w-[240px] bg-gradient-to-r from-orange-500 via-red-600 to-yellow-500 hover:from-orange-600 hover:via-red-700 hover:to-yellow-600 text-white border-0 shadow-lg font-semibold py-3 px-4 h-auto text-sm transition-all duration-200 animate-[flame_2s_ease-in-out_infinite] overflow-hidden"
          >
            <div className="flex flex-col items-center gap-1">
