...
const RatingStatusChecker: React.FC<RatingStatusCheckerProps> = ({
  userId,
  children,
}) => {
  ...
  const checkRatingStatus = async () => {
    try {
      ...
      // Check if user has made any ratings (as a rater)
      ...
      // Check if user has been rated (as a user being rated)
