  ...
  return (
    <section className={`w-full bg-transparent py-12 md:py-16 ${className}`}>
      ...
      <div className="relative w-full">
        ...
        <div
          ref={scrollRef}
          className="flex w-full min-w-0 max-w-full gap-3 md:gap-6 overflow-x-auto py-2 px-0 scroll-smooth snap-x snap-mandatory justify-start [touch-action:pan-x_pan-y] [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
        >
