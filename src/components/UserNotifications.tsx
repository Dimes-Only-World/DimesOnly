                    ...
                    {notification.media_url && (
                      <div className="mt-2">
                        {notification.media_type === 'photo' ? (
                          ...
                          <video src={notification.media_url} className="w-24 h-24 object-cover rounded" controls / controlsList="nodownload" disablePictureInPicture disableRemotePlayback>
                        )}
                      </div>
                    )}
