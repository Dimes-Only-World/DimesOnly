        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <div className="bg-yellow-400 text-black p-4 rounded-lg mb-6">
              ...
              <p className="mb-2">
                Any questions Email Question with your username to:
              </p>
              <p className="font-bold text-xl mb-2">Talent@DimesOnly.World</p>
              <p className="mb-2">
                Paid positions are available & can make you up to $25,000 a
                year.
              </p>
              ...
              <p className="mb-2">
                IF YOU DO NOT UNDERSTAND THE BENEFITS, CONTACT US TO MAKE AN
                INFORMED DECISION.
              </p>
              <p className="font-bold">
                Fill out the Application when you are ready.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {packages.map((pkg, index) => (
              <Card
                key={index}
                className="bg-black/80 border-2 border-pink-500 text-white"
              >
                <CardHeader>
                  ...
                  {pkg.badge && (
                    <Badge className="bg-red-600 text-white">{pkg.badge}</Badge>
                  )}
                  {pkg.savings && (
                  ...
                  {pkg.subtitle && (
                    <p className="text-yellow-400 font-bold">{pkg.subtitle}</p>
                  )}
                  {pkg.monthly && (
