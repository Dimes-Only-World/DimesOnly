      ...
      <div className="min-h-screen bg-[#0B0B0D] text-white">
        ...
        <div className="max-w-md mx-auto px-4 py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-6 w-full sm:w-auto sm:justify-center">
            <button onClick={() => navigate(buildAuthUrl("/login", "/flix/earn"))} className="bg-[#FF4D1A] hover:bg-[#ff5d30] text-white font-bold px-8 py-3 rounded-md sm:min-w-[160px]">
              Sign In
            </button>
            <button onClick={() => navigate(buildAuthUrl("/register", "/flix/earn"))} className="bg-[#FF4D1A] hover:bg-[#ff5d30] text-white font-bold px-8 py-3 rounded-md sm:min-w-[160px]">
              Register Now
            </button>
          </div>
        </div>
