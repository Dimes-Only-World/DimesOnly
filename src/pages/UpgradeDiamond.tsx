        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 mb-4">
              Join the elite $25,000/year guarantee program<br>Plus<br>Equality Opportunity: Make up to $74,985.00 a year from adding nudes to your profile view by silver members<br>Plus<br>Make up to $112,500.00 a year from adding x-rated content to your profile view by gold members.
            </p>
...
<p className="text-xl text-gray-300 mb-4">
              Equality Opportunity: Make up to $74,985.00 a year from adding nudes to your profile view by silver members<br>Plus<br>Make up to $112,500.00 a year from adding x-rated content to your profile view by gold members.<br>Compensation from Silver and Gold purchases is equally distributed amongst the first 1,000 Dimes.
            </p>
          </div>
